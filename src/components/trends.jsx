  ...
  return (
    <div className="max-w-[1200px] bg-[#FBFBFB] px-[30px] md:px-[40px] gap-[30px] flex-col lg:flex-row mx-auto flex py-[100px]">
      <div className="flex gap-[30px] flex-col items-center sm:flex-row">
        <img src="/public/trends/image 14 (1).png" className='w-[300px] mx-auto sm:w-[auto]' alt="img1" />
        <div className='text-center sm:text-end'>
          ...
          <MainButton>
            <div className='flex  gap-[5px]'>
              Find More
              <img src="/public/trends/Arrow - Right.svg" alt="" />
            </div>
          </MainButton>
        </div>
      </div>
      <div className="flex gap-[30px] flex-col items-center sm:flex-row">
        <img src="/public/trends/image 15.png"  className='w-[300px] mx-auto sm:w-[auto]' alt="img1" />
        <div className='text-center sm:text-end'>
